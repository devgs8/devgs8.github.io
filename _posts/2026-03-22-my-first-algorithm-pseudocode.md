...
| Component | Purpose |
|-----------|---------|
| `Algoritmo` | Declares the start with the algorithm name |
| `Var` | Section where variables are declared |
| `Inicio` | Marks the beginning of the logic |
| `Fim` | Marks the end of the algorithm |
